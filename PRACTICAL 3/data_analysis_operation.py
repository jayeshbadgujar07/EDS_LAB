...
print("Roll no who got maximum marks in Subject 3",  a[b,0] )

# 14. print Roll number who got minimum marks in Subject 2
c=np.argmin(a[:,2])
print("Roll no who got minimum marks in Subject 2",a[c,0])

# 15. print Roll number who got 24 marks in Subject 2
c= np.where(a[:,2]==24)
print("Roll no who got 24 marks in Subject 2",  a[c,0])

# 16. print count of students who got marks in Subject 1 < 40
d=np.sum(a[:,1]<40)
print("Count of students who got marks in Subject 1 < 40", d )

# 17. print count of students who got marks in Subject 2 > 90
e=np.sum(a[:,2]>90)
print("Count of students who got marks in Subject 2 > 90:",  e)
