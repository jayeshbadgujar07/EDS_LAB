...
passangers_by_class = data['Pclass'].value_counts()
print(passangers_by_class)

# 7. Get the number of passengers by gender
passangers_by_gender = data["Sex"].value_counts()
print(passangers_by_gender)

# 8. Get the number of passengers by survival status
survival_status_counts = data['Survived'].value_counts()
